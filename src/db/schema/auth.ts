...
export const refreshTokens = pgTable("refresh_tokens", {
  ...
  // Server-side portal flag (admin vs user) checked on refresh rotation so one portal's token can't rotate into the other's session; existing rows default to "user".
